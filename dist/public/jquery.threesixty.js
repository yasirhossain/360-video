...
(($, THREE, Detector, window, document, undefined) => {
    ...
    Plugin.prototype = {
        init: function() {
          ...
          if (this.element.classList)
            this.element.classList.add('Valiant360_default')
          else
            this.element.className += ' ' + 'Valiant360_default'
          ...
          if(this.element.getAttribute('data-photo-src')) {
            ...
            this._video.addEventListener("progress", () => {
              ...
              if (this.paused === false){
                ...
                self.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].children[0].setAttribute("style", "width:" + percent + "%;")
                self.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].children[1].setAttribute("style", "width:" + (100 - percent) + "%;")
    						//Update time label
        ...
        attachControlEvents: function() {
          ...
          self.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].addEventListener("click", this.onProgressClick.bind(this), false)
			    self.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].addEventListener("mousemove", this.onProgressMouseMove.bind(this), false)
			    self.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].addEventListener("mouseout", this.onProgressMouseOut.bind(this), false)
        ...
        onProgressClick: function(event) {
          if(this._isVideo && this._video.readyState === this._video.HAVE_ENOUGH_DATA) {
            ...
            this.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].children[0].setAttribute("style", "width:" + percent + "%;")
            this.element.querySelectorAll('.controlsWrapper > .valiant-progress-bar')[0].children[1].setAttribute("style", "width:" + (100 - percent) + "%;")
